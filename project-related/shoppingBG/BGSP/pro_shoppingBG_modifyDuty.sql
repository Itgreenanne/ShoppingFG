...
f_manageProduct AS mangProduct, f_manageOrder AS mangOrder, f_manageRecord AS mangRecord FROM t_duty WHERE f_id= @dutyId FOR JSON PATH, WITHOUT_ARRAY_WRAPPER)
