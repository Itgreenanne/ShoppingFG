...
SELECT f_id, f_orderNumber, f_totalPrice, f_discount, f_payment, f_idNumber, f_createTime FROM t_order WHERE f_createTime >= @startDate AND f_createTime <= @endDate+1
