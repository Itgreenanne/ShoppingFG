USE ShoppingBG
GO
CREATE PROCEDURE pro_shoppingBG_delMember @userId INT, @memberId INT
AS 
BEGIN

INSERT INTO t_operationRecord(f_userId, f_dataId, f_type, f_function, f_before, f_after )
VALUES(@userId, @memberId, 4, 2,'', (SELECT CONCAT('„h³ý', f_title) FROM t_product WHERE f_id=@memberId ))
