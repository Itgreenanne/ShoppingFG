USE ShoppingBG
GO
CREATE PROCEDURE pro_shoppingBG_modifyMember @userId INT, @id INT, @tel CHAR(10), @pwd NVARCHAR(20), @gender TINYINT, @lastName NVARCHAR(20),  @firstName NVARCHAR(20), @birth CHAR(10),
...
VALUES(@userId, @id, 4, 3, @before, @after)
SELECT 1 AS result
